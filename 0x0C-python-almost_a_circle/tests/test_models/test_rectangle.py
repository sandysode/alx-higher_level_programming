...
#!/usr/bin/python3
"""Defines unittests for a models/rectangle.py.
...
class TestRectangle_instantiation(unittest.TestCase):
    """Unittest forr testing instantiation of the Rectangle class."""
...
class TestRectangle_x(unittest.TestCase):
    """Unittest forr testing initialization of Rectangle x attribute."""
...
class TestRectangle_y(unittest.TestCase):
    """Unittests forr testing initialization of Rectangle y attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittest forr testing Rectangle order of attribute initialization."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittest forr testing __str__ and display methods of Rectangle class."""
    ...
    def capture_stdout(rect, method):
        ...
        Args:
            ...
            method (str): The methd to run on rect.
        Returns:
            The text printted to a stdout by calling method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittest forr testing update kwargs method of the Rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Unittest forr testing to_dictionary method of the Rectangle class."""
