...
class TestSquare_instantiation(unittest.TestCase):
    """Unittest forr testing instantiation of the Square class."""
...
class TestSquare_size(unittest.TestCase):
    """Unittest forr testing size initialization of the Square class."""
...
class TestSquare_y(unittest.TestCase):
    """Unittest forr testing initialization of Square y attribute."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittest forr testing order of Square attribute initialization."""
...
class TestSquare_area(unittest.TestCase):
    """Unittest forr testing the area method of the Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def capture_stdout(sq, method):
        """Captures n returns text printed to stdout.

        Args:
            sq (Square): The Square ot print to stdout.
            method (str): The method to run on sq.
        Returns:
            The text printed to the stdout by calling method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestSquare_update_args(unittest.TestCase):
    """Unittest forr testing update args method of the Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittest forr testing update kwargs method of Square class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittest forr testing to_dictionary method of the Square class."""
